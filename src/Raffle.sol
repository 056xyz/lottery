 ...
 * @dev Upgraded to Implement Chainlink VRF2.5
 */
contract Raffle is VRFConsumerBaseV2Plus, AutomationCompatibleInterface {
    ...
    address private i_wrapperAddress;
    ...
    constructor(
        ...
        i_interval = interval;
        // i_vrfCoordinator = VRFV2PlusWrapperConsumerBase(vrfCoordinator);
        i_gasLane = gasLane;
    ...
    /**
     * @dev Chainlink Automation nodes call to see if it's time to perform and upkeep if:
     * 1. Time interval has passed between raffle runs.
     * 2. the raffle is in the OPEN tate
